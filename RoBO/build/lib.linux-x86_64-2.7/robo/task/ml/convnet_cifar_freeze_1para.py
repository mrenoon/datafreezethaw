...
class ConvNetCifar(BaseTask):
    ...
    def objective_function(self, x):
        ...
        layersParamsTemplatePath = ROOT_ML_DIR + "RoBO/examples/dataFreeze/layer-params-template.cfg"
        ...
        # wc4 = x[0][5]
        # wc5 = x[0][6]
        open(layersParams,"w").write(template % ( epsW, epsW, epsW, epsW, epsW))
        ...
        print ":::::        ml.convnet_cifar_freeze, In objective function, after training, got this val_lossess:    ", val_losses
